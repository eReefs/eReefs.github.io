...
Execute this code at the command line by typing:
  ...
  python eReefs-installation-test-2.py
...
of Python that you have installed with 'eReefs-installation-test-1.py'.

By default, this script will test for all the dependencies you
need.

Based on the software carpentry testing code.
"""
...
def print_suggestions(instructor_fallback=True):
    print()
    print('For suggestions on installing missing packages, see the original set up docs provided.')
    print('')
